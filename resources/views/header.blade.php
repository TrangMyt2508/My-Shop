<div id="header">
	<style>
		.header-top{ background-color: #8eb4cb; }
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="https://www.facebook.com/DuyRNT"><i class="fa fa-home"></i> 91 Đường Cầu Diễn, Phúc Diễn, Từ Liêm, Hà Nội, Vietnam
							</a></li>
						<li><a href="https://www.facebook.com/DuyRNT"><i class="fa fa-phone"></i> 0373320519 </a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/img/92we.jpg" width="200px" alt=""></a>
				</div>
